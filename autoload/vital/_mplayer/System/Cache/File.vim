...
execute join(['function! vital#_mplayer#System#Cache#File#import() abort', printf("return map({'_vital_depends': '', 'dump': '', 'hash': '', 'load': '', 'new': '', '_vital_loaded': ''}, \"vital#_mplayer#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
